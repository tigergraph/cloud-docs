...
The following example makes a request to the https://www.tigergraph.com/docs/tigergraph-server/4.3/API/built-in-endpoints/#_list_vertices[List vertices^] endpoint on a cluster with the https://www.youtube.com/watch?v=s6-QapCEz1M&feature=youtu.be&ab_channel=TigerGraph[COVID-19 starter kit].
...
See https://www.tigergraph.com/docs/tigergraph-server/4.3/API/built-in-endpoints/[Built-in Endpoints^] to learn about all the endpoints available.
