...
== Data encryption
* Automatic data in-transit encryption: TLS 1.2 for all endpoints
* Automatic data at-rest encryption: native encryption functionality through cloud providers
