...
Please visit our link:https://tigergraph.com/solutions/[TigerGraph Savanna Solutions] page to watch the overview video for each solution.
...
TigerGraph Savanna enables https://www.tigergraph.com/docs/tigergraph-server/4.3/API/authentication/[REST{pp} Authentication^] to securely connect TigerGraph Savanna workspaces with your application through an endpoint on port 443 at `443/restpp/<endpoint>`.
...
A: A list of third-party software used in the TigerGraph engine and TigerGraph Savanna is available at https://www.tigergraph.com/docs/tigergraph-server/4.3/reference/patents-and-third-party-software/[Patents and Third-Party Software^].
//
