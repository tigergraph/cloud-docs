...
* Invoice generation, downloads, payment status, and access to historical invoices
...
Because the transition may extend beyond a typical monthly billing cycle, the resulting invoice or payment may be higher than usual.
...
=== Will I be able to access my historical invoices?

Historical invoices generated before *August 19, 2026* will not be available in Savanna during or after the billing platform transition.

We recommend downloading any invoices you may need before the transition begins. If you need a historical invoice after August 19, 2026, TigerGraph Support can provide it upon request.
