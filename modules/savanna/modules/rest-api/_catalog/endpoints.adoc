...
// Cloud provider operations are present in the OpenAPI catalog but were not
// emitted by the legacy AsciiDoc generator. These minimal entries preserve the
// catalog as the endpoint/nav allowlist; page content comes from openapi.json.

[[_https_api_tgcloud_io_controller_v4_v2_cloud_providers_post]]
== Create a new cloud provider
....
POST https://api.tgcloud.io/controller/v4/v2/cloud-providers
....
...
[[_https_api_tgcloud_io_controller_v4_v2_cloud_providers_get]]
== List all cloud providers belonging to the org
....
GET https://api.tgcloud.io/controller/v4/v2/cloud-providers
....
...
[[_https_api_tgcloud_io_controller_v4_v2_cloud_providers_public_get]]
== List public cloud providers
....
GET https://api.tgcloud.io/controller/v4/v2/cloud-providers/public
....
...
[[_https_api_tgcloud_io_controller_v4_v2_cloud_providers_validate_post]]
== Validate a cloud provider request
....
POST https://api.tgcloud.io/controller/v4/v2/cloud-providers/validate
....
...
[[_https_api_tgcloud_io_controller_v4_v2_cloud_providers_cloudproviderid_get]]
== Get a cloud provider by ID
....
GET https://api.tgcloud.io/controller/v4/v2/cloud-providers/{cloudProviderID}
....
...
[[_https_api_tgcloud_io_controller_v4_v2_cloud_providers_cloudproviderid_put]]
== Update a cloud provider
....
PUT https://api.tgcloud.io/controller/v4/v2/cloud-providers/{cloudProviderID}
....
...
[[_https_api_tgcloud_io_controller_v4_v2_cloud_providers_cloudproviderid_delete]]
== Delete a cloud provider
....
DELETE https://api.tgcloud.io/controller/v4/v2/cloud-providers/{cloudProviderID}
....
...
[[_https_api_tgcloud_io_controller_v4_v2_cloud_providers_cloudproviderid_upgrade_put]]
== Upgrade a cloud provider
....
PUT https://api.tgcloud.io/controller/v4/v2/cloud-providers/{cloudProviderID}/upgrade
....
...
// Add-on operations are present in the OpenAPI catalog but were not
// emitted by the legacy AsciiDoc generator. These minimal entries preserve the
// catalog as the endpoint/nav allowlist; page content comes from openapi.json.
// POST /addons/request is omitted: it files a request for an unavailable add-on,
// not the install/configure path used by GraphStudio, Insights, and GraphQL.

[[_https_api_tgcloud_io_controller_v4_v2_addons_meta_get]]
== List available add-ons
....
GET https://api.tgcloud.io/controller/v4/v2/addons/meta
....
...
[[_https_api_tgcloud_io_controller_v4_v2_addons_addonsid_install_post]]
== Install an add-on
....
POST https://api.tgcloud.io/controller/v4/v2/addons/{addonsID}/install
....
...
[[_https_api_tgcloud_io_controller_v4_v2_installed_addons_get]]
== List installed add-ons
....
GET https://api.tgcloud.io/controller/v4/v2/installed-addons
....
...
[[_https_api_tgcloud_io_controller_v4_v2_installed_addons_installedaddonsid_get]]
== Get installed add-on details
....
GET https://api.tgcloud.io/controller/v4/v2/installed-addons/{installedAddonsID}
....
...
[[_https_api_tgcloud_io_controller_v4_v2_addons_addonsid_workspaces_get]]
== List add-on workspaces
....
GET https://api.tgcloud.io/controller/v4/v2/addons/{addonsID}/workspaces
....
...
[[_https_api_tgcloud_io_controller_v4_v2_installed_addons_installedaddonsid_configs_configname_get]]
== List add-on configurations
....
GET https://api.tgcloud.io/controller/v4/v2/installed-addons/{installedAddonsID}/configs/{configName}
....
...
[[_https_api_tgcloud_io_controller_v4_v2_add_ons_installedaddonsid_configs_post]]
== Create an add-on configuration
....
POST https://api.tgcloud.io/controller/v4/v2/add-ons/{installedAddonsID}/configs
....
...
[[_https_api_tgcloud_io_controller_v4_v2_add_ons_installedaddonsid_configs_configid_put]]
== Update an add-on configuration
....
PUT https://api.tgcloud.io/controller/v4/v2/add-ons/{installedAddonsID}/configs/{configID}
....
...
[[_https_api_tgcloud_io_controller_v4_v2_add_ons_installedaddonsid_configs_configid_delete]]
== Delete an add-on configuration
....
DELETE https://api.tgcloud.io/controller/v4/v2/add-ons/{installedAddonsID}/configs/{configID}
....
...
== List backups
....
GET https://api.tgcloud.io/controller/v4/v2/workgroups/{workgroupID}/workspaces/{workspaceID}/backups
....
...
....
GET https://api.tgcloud.io/controller/v4/v2/workgroups/{workgroupID}/workspaces/{workspaceID}/backups/{job}/status
....
...
[[_https_api_tgcloud_io_controller_v4_v2_workgroups_workgroupid_workspaces_workspaceid_schedules_post]]
== Create a new workspace schedule
....
POST https://api.tgcloud.io/controller/v4/v2/workgroups/{workgroupID}/workspaces/{workspaceID}/schedules
....
...
[[_https_api_tgcloud_io_controller_v4_v2_workgroups_workgroupid_workspaces_workspaceid_schedules_get]]
...
|===
|HTTP Code|Description|Schema
|**200**|OK|<<_https_api_tgcloud_io_controller_v4_v2_workgroups_workgroupid_workspaces_workspaceid_schedules_get_response_200,Response 200>>
|**500**|Internal Server Error|<<definitions.adoc#_middleware_response,middleware.Response>>
|===

[[_https_api_tgcloud_io_controller_v4_v2_workgroups_workgroupid_workspaces_workspaceid_schedules_get_response_200]]
**Response 200**
...
[[_https_api_tgcloud_io_controller_v4_v2_workgroups_workgroupid_workspaces_workspaceid_schedules_scheduleid_put]]
== Update an existing workspace schedule
....
PUT https://api.tgcloud.io/controller/v4/v2/workgroups/{workgroupID}/workspaces/{workspaceID}/schedules/{scheduleID}
....
...
|===
|HTTP Code|Description|Schema
|**200**|OK|<<_https_api_tgcloud_io_controller_v4_v2_workgroups_workgroupid_workspaces_workspaceid_schedules_scheduleid_put_response_200,Response 200>>
|**400**|Bad Request|<<definitions.adoc#_middleware_response,middleware.Response>>
|**500**|Internal Server Error|<<definitions.adoc#_middleware_response,middleware.Response>>
|===

[[_https_api_tgcloud_io_controller_v4_v2_workgroups_workgroupid_workspaces_workspaceid_schedules_scheduleid_put_response_200]]
**Response 200**
...
[[_https_api_tgcloud_io_controller_v4_v2_workgroups_workgroupid_workspaces_workspaceid_schedules_scheduleid_delete]]
== Delete an existing workspace schedule
....
DELETE https://api.tgcloud.io/controller/v4/v2/workgroups/{workgroupID}/workspaces/{workspaceID}/schedules/{scheduleID}
....
...
|===
|HTTP Code|Description|Schema
|**200**|OK|<<_https_api_tgcloud_io_controller_v4_v2_workgroups_workgroupid_workspaces_workspaceid_schedules_scheduleid_delete_response_200,Response 200>>
|**500**|Internal Server Error|<<definitions.adoc#_middleware_response,middleware.Response>>
|===

[[_https_api_tgcloud_io_controller_v4_v2_workgroups_workgroupid_workspaces_workspaceid_schedules_scheduleid_delete_response_200]]
**Response 200**
