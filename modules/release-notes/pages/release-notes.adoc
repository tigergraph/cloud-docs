...
* TigerGraph Version 3.6.0 is now supported when creating new solutions.
* xref:private-access:index.adoc[] are now supported when creating new solutions.
...
* TigerGraph Version 3.5.3 is now supported when creating new solutions.
