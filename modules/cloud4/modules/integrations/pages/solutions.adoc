...
== Prerequisites
To start creating your first solution you will need to have a xref:cloud4:workgroup-workspace:workspaces/writeread_readonly.adoc#_read_write_rw_workspace[Read-Write Workspace]  already created.
