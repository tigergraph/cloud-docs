...
. For advanced settings please refer to xref:cloud4:workgroup-workspace:workspaces/workspace-settings/workspace-settings.adoc[] page.
...
For more details, please refer to xref:cloud4:workgroup-workspace:workspaces/writeread_readonly.adoc[].
+
