...
The public and private IPs of a peered solution are shown just like any other solution. To view IP addresses, click on the instance on the *My Solutions* page. The IPs will be shown on the right side of the expanded information box.
