...
[[_workspaceaddonsrequest]]
=== WorkspaceAddonsRequest
...
__optional__
|< xref:rest-api:definitions.adoc#_constants_clusterlogtype[constants.ClusterLogType] > array
|**component_versions** +
__optional__
|string
|**created_at** +
...
|**node_group_config** +
__optional__
|xref:rest-api:definitions.adoc#_aws_nodegroupconfig[aws.NodeGroupConfig]
|**options** +
__optional__
|xref:rest-api:definitions.adoc#_cloudprovideroptions[CloudProviderOptions]
|**org_id** +
__optional__
|string
|**platform** +
...
[[_createcloudproviderresourcerequest]]
=== CreateCloudProviderResourceRequest
...
|**address** +
__optional__
|xref:rest-api:definitions.adoc#_updateaddressrequest[UpdateAddressRequest]
|**customer_email** +
__optional__
|string
|**customer_id** +
...
|**Type** +
__optional__
|xref:rest-api:definitions.adoc#_errortype[ErrorType]
|===
...
[[_getcustomercreditcardsresponse]]
...
|**credit_cards** +
__optional__
|< xref:rest-api:definitions.adoc#_customercreditcard[CustomerCreditCard] > array
|**default_card** +
__optional__
|string
|===
...
|**metadata** +
__optional__
|xref:rest-api:definitions.adoc#_tgiam_metadata[tgIAM.Metadata]
|**path** +
__optional__
|string
|**role** +
...
|**metadata** +
__optional__
|xref:rest-api:definitions.adoc#_orgmetadata[OrgMetadata]
|**path** +
__optional__
|string
|**roles** +
__optional__
|< xref:rest-api:definitions.adoc#_orgrole[OrgRole] > array
|**tenantID** +
__optional__
|string
|**trn** +
...
|**feature_flag** +
__optional__
|< xref:rest-api:definitions.adoc#_featureflag[FeatureFlag] > array
|**logo_url** +
__optional__
|string
|**org_display_name** +
...
[[_publiccloudproviderresource]]
=== PublicCloudProviderResource
...
|**addon_pricing** +
__optional__
|< xref:rest-api:definitions.adoc#_addonpricing[AddOnPricing] > array
|**data_storage_pricing** +
__optional__
|< xref:rest-api:definitions.adoc#_datastoragepricing[DataStoragePricing] > array
|**workspace_pricing** +
__optional__
|< xref:rest-api:definitions.adoc#_workspacepricing[WorkspacePricing] > array
|===
...
|**ErrorDetails** +
__optional__
|< xref:rest-api:definitions.adoc#_error[Error] > array
|**Message** +
__optional__
|string
|**RequestID** +
...
[[_servermcpchatrequest]]
=== ServerMCPChatRequest
...
[[_updatecloudproviderresourcerequest]]
=== UpdateCloudProviderResourceRequest
...
[[_upgradecloudprovidercomponent]]
=== UpgradeCloudProviderComponent
...
[[_upgradecloudproviderresourcerequest]]
=== UpgradeCloudProviderResourceRequest
...
|**components** +
__optional__
|< xref:rest-api:definitions.adoc#_upgradecloudprovidercomponent[UpgradeCloudProviderComponent] > array
|**node_group_config** +
__optional__
|xref:rest-api:definitions.adoc#_aws_nodegroupconfig[aws.NodeGroupConfig]
|===

[[_upgradeworkspacerequest]]
...
[[_validatecloudproviderrequest]]
=== ValidateCloudProviderRequest
...
|**regions** +
__optional__
|< xref:rest-api:definitions.adoc#_region[Region] > array
|**tgVersions** +
__optional__
|< xref:rest-api:definitions.adoc#_tgversion[TGVersion] > array
|**workspaceTypes** +
__optional__
|< xref:rest-api:definitions.adoc#_workspacetype[WorkspaceType] > array
|===
...
|**ng_16** +
__optional__
|xref:rest-api:definitions.adoc#_aws_nodegroup[aws.NodeGroup]
|**ng_32** +
__optional__
|xref:rest-api:definitions.adoc#_aws_nodegroup[aws.NodeGroup]
|**ng_48** +
...
[[_constants_clusterlogtype]]
=== constants.ClusterLogType

Type: string

[[_data_encryptionmethod]]
=== data.EncryptionMethod

Type: string

[[_observability_metricvalue]]
...
[[_observability_workgroupmetric]]
=== observability.WorkgroupMetric

Metrics for workspaces in a workgroup
...
|**workspaceMetrics** +
__optional__
|< xref:rest-api:definitions.adoc#_observability_workspacemetric[observability.WorkspaceMetric] > array
|===

[[_observability_workspacemetric]]
=== observability.WorkspaceMetric
...
|**metrics** +
__optional__
|object<string, xref:rest-api:definitions.adoc#_observability_metricvalue[observability.MetricValue]>
|**workspaceID** +
__optional__
|string
|===
