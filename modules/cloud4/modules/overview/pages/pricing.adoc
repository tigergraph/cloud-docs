...
<tr><td class="tableblock halign-left valign-top"><p class="tableblock">TG-128</p></td><td class="tableblock halign-left valign-top"><p class="tableblock">1024</p></td><td class="tableblock halign-left valign-top"><p class="tableblock">8,192</p></td><td class="tableblock halign-left valign-top"><p class="tableblock">128.00</p></td></tr>
</tbody>
</table>
</div>
...
<script>
  const basePrices = [
            ...
            { size: 'TG-128', vcpus: 1024, memory: '8,192', price: 128 }
        ];
  const pricingData = {
    'AWS': {
