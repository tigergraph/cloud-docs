...
TigerGraph Cloud Classic user accounts have their own password requirements separate from the https://www.tigergraph.com/docs/tigergraph-server/4.3/security/password-policy/[TigerGraph Server password policy^].
...
If you forget your password, click the btn:[Forgot Password?] button during login, or contact savanna-support@tigergraph.com for assistance.
====
