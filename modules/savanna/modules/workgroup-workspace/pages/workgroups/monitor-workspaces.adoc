...
TigerGraph Savanna offers comprehensive monitoring capabilities that allow you to track the status and resource usage of your workspaces.
...
Next, Learn how to xref:graph-development:load-data/index.adoc[Load Data] into TigerGraph Savanna.
