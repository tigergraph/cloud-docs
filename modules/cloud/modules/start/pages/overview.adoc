...
[NOTE]
====
TigerGraph Cloud 4 Beta was released on Apr. 29, 2024.
...
// [NOTE]
// ====
// On December 31, 2025, we'll retire the TigerGraph Cloud Classic platform. Before that date, you’ll need to migrate your data from TigerGraph Cloud Classic to TigerGraph Cloud 4. For support, please contact us at support@tigergraph.com.
// ====
