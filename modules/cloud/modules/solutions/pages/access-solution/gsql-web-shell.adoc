...
Please see the main https://www.tigergraph.com/docs/tigergraph-server/4.3/gsql-shell/web/[GSQL Shell documentation page^] for complete information.
...
Please contact savanna-support@tigergraph.com to discuss migration to a newer version.
