...
== Data encryption
* Automatic https://www.tigergraph.com/docs/tigergraph-server/4.3/security/encrypting-connections/[data in-transit encryption^]: TLS 1.2 for all endpoints
* Automatic https://www.tigergraph.com/docs/tigergraph-server/4.3/security/encrypting-data-at-rest/[data at-rest encryption^]: native encryption functionality through cloud providers
