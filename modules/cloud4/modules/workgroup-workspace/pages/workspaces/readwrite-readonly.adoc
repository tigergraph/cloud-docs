...
Next, about xref:workspaces/workspace-size.adoc[Workspace Sizes] or learn how to xref:cloud4:workgroup-workspace:expansion_shrink.adoc[Expand and Shrink] a workspace.
