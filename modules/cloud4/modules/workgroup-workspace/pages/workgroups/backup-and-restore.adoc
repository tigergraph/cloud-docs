...
[IMPORTANT]
====
Backup functionality is currently available only for xref:cloud4:workgroup-workspace:workspaces/readwrite-readonly.adoc#_read_write_rw_workspace[Read-Write (RW) workspaces].
