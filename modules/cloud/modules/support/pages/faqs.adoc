...
* If you requested a password reset from an organization login screen, you won't get an email if you don't belong to that organization. Try resetting your password from the main login page at link:https://tgcloud.io[].
...
If you're still unable to log in or reset your password, contact TigerGraph Support at savanna-support@tigergraph.com for individualized help with your issue.
...
Now you can run queries on the starter kit's sample data. Please visit link:https://www.youtube.com/@TigerGraph/search?query=starter%20kit[TigerGraph's YouTube channel'] to watch an overview video for your starter kit.
...
See TigerGraph's https://www.tigergraph.com/docs/gui/4.3/admin-portal/overview/[Admin Portal Documentation^] for more detailed information.
...
You can start learning GSQL from our https://www.tigergraph.com/docs/gsql-ref/4.3/tutorials/gsql-101/[GSQL tutorials^]. We also support a RESTful API and JSON output for easy integration with application languages like Python, Java, and C{pp}.
...
A: Yes. If you use V3.0.5+ in TigerGraph Cloud Classic, MultiGraph is supported through GraphStudio. Please refer to our https://www.tigergraph.com/docs/gui/4.3/graphstudio/design-schema/[Design a Schema^] page for the new MultiGraph Support through GraphStudio.
...
A: Yes. You can purchase cloud credits applied to TigerGraph Cloud Classic usage.
...
A:  You can find our terms and conditions here: https://www.tigergraph.com/terms[www.tigergraph.com/terms].
...
Please read the https://www.tigergraph.com/docs/tigergraph-server/4.3/cluster-and-ha-management/ha-cluster/[High Availability Cluster Configuration^] documentation for additional details about partitions and replications.
...
A: When you register your account, you will select a username and password. You can then log in anytime at link:https://www.tgcloud.io/[www.tgcloud.io]. You will also be given a URL using a subdomain name that you select.
...
TigerGraph Cloud Classic enables https://www.tigergraph.com/docs/tigergraph-server/4.3/API/authentication/[REST{pp} Authentication^] to securely connect TigerGraph Cloud Classic clusters with your application through an endpoint on port 443 at `443/restpp/<endpoint>`.
...
Please see more detailed pages on the https://www.tigergraph.com/docs/tigergraph-server/4.3/user-access/sso/[Single Sign On (Server)^] and https://www.tigergraph.com/docs/gui/4.3/admin-portal/security/sso/[Single Sign On (GUI)^] features.
...
The https://www.tigergraph.com/docs/gui/4.3/graphstudio/load-data/[Load Data^]  page includes a real time monitor and statistics. Query performance and many other measures are available on the https://www.tigergraph.com/docs/tigergraph-server/4.3/intro/[Administrator Portal^].
...
A: A list of third-party software used in the TigerGraph engine and TigerGraph Cloud Classic is available at https://www.tigergraph.com/docs/tigergraph-server/4.3/reference/patents-and-third-party-software/[Patents and Third-Party Software^].
