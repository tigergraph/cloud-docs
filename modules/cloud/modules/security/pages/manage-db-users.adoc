...
For details on TigerGraph's role-based access control model, see https://www.tigergraph.com/docs/tigergraph-server/4.3/user-access/access-control-model/#_role_based_access_control[Access Control Model^].
