...
* Integrated a new starter kit fully optimized for xref:ml-workbench:on-cloud:on-tgcloud.adoc[Machine Learning Workbench]
...
* Added Jakarta (Indonesia) region to AWS.
* Added Arizona (US) and Washington (US) region to Azure.
* Re-organized starter-kits into new categories.
* Added user and organization activity logging.
