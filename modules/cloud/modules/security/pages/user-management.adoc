...
On the individual cluster level, the same https://www.tigergraph.com/docs/gui/4.3/admin-portal/management/user-management/[role-based access control^] used by the on-premises version of TigerGraph also applies to TigerGraph Cloud Classic.
...
For more information on how to manage users and roles in Admin Portal, see https://www.tigergraph.com/docs/gui/4.3/admin-portal/management/user-management/[Manage Users^].
