...
Only an Organization Admin can create a new user account for someone else to use. Organization Members and Organization Solution Admins cannot create their own accounts; they need to be invited via email after their accounts are created for them.

See xref:managa-org-users.adoc#_invite_new_users[Invite new users] for more detailed instructions.
...
See xref:managa-org-users.adoc#_organization_roles_and_privileges[Organization roles and privileges] for detailed information on the privileges available to each organization role.
