...
* For more information about the database roles and their capabilities, please refer to the TigerGraph documentation https://www.tigergraph.com/docs/gui/4.3/graphstudio/user-access-management/#_role_and_graph_based_access_control[Role and Graph Based Access Control^].
====
