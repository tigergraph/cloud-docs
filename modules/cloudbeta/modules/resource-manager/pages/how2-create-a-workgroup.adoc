...
[.next-button]#xref:cloudBeta:resource-manager:workspaces/workspace.adoc[Link Text]#


++++
<span class="next-button">xref:cloudBeta:resource-manager:workspaces/workspace.adoc[Link Text]</span>
++++
