...
. For advanced settings please refer to xref:cloud4:resource-manager:workspaces/advanced-settings/advanced-settings.adoc[] page.
...
Now, that you have a workspace created see xref:cloud4:resource-manager:workspaces/advanced-settings/advanced-settings.adoc[] or learn more about xref:cloud4:resource-manager:workspaces/writeread_readonly.adoc[].
