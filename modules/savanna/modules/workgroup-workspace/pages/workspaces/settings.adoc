...
You can change this schedule at any time after the workspace is created.

[NOTE]
====
The maintenance interval can be set to any value from 1 week to 52 weeks. Values outside this range are not supported.
====
