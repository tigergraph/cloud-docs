...
* *Configurable Maintenance Window for Auto-Upgrades:* You can now set a preferred weekly maintenance window in Savanna. Automatic version upgrades will run during your chosen time slot, giving you more control over your maintenance schedule.
...
* *Encrypted Log Management and Search:* Users can securely collect, store, and perform full-text search of application logs using Bring Your Own Key (BYOK) encryption, improving both visibility and operational efficiency.
...
* *Snowflake Integration with Savanna:* You can now connect securely to Snowflake from Savanna. Preview sample data, auto-generate graph schemas and mappings, customize data transformations, and manage your data loading jobs directly within Savanna.

==== DB Updates

* *TigerGraph 4.2 Preview Now Available in Savanna:* Preview TigerGraph Database version 4.2 in Savanna to access the latest features and enhancements ahead of general availability.
