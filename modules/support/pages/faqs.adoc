...
A backup file, however, can be used to restore to a new cluster within 15 days.
...
A: Only single server clusters can be restored from the backup of another cluster in the same account within the same cloud platform.
