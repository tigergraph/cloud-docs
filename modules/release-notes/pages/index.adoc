...
* Overhauled Billing and Network page designs to greatly streamline the user experience.
* Removed $25 free credit for new accounts. To purchase Cloud credits for an organization account
* Contact TigerGraph Support to perform Backup and Restore from another cluster.
