...
image::image%20%2838%29%20%287%29%20%282%29.png[TigerGraph Cloud Dashboard view]
...
image::image%20%2858%29%20%281%29%20%281%29.png[]
...
image::image%20%2857%29.png[Cloud platform and instance type options]

*6. Select Region.*

image::image%20%2847%29.png[Regions for AWS]
...
image::image%20%2819%29%20%281%29.png[]
...
image::image%20%2843%29.png[GraphStudio login page]
