...
== Sign up
Click btn:[Sign Up] on the https://portal.tgcloud.io/[TigerGraph Cloud landing page].
...
| Release Notes | Yes | TigerGraph Cloud provides database versions kept up to date with TigerGraph Server releases.
