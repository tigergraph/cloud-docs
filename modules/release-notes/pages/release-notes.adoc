...
* Enabled multiple users to share access to the same organization account
* Implemented Role based access control (RBAC)  to control/manage access to different functionalities and screens
* Integrated login between TIgerGraph Cloud Console and Graph Studio to eliminate redundant logins
