...
[NOTE]
====
The https://www.tigergraph.com/docs/tigergraph-server/4.3/gsql-shell/web/[GSQL Web Shell^] is currently not supported on Azure-hosted clusters due to a limitation with Azure Application Gateway.
