...
| **Suspend Grace Period (Days)** | 0                                | 3                                | 5                                | 7                                      
| **Terminate Grace Period (Days)** | 7                                | 10                                | 20                               | 30                                     
...
- **Suspend Grace Period (Days)**: The number of days before a workspace is suspended.
- **Terminate Grace Period (Days)**: The number of days a suspended workspace remains suspended before it is permanently    terminated.
