...
Next, learn more about how to xref:savanna:workgroup-workspace:workspaces/connect-via-api.adoc[] a workspace, or xref:savanna:workgroup-workspace:workgroups/monitor-workspaces.adoc[].
